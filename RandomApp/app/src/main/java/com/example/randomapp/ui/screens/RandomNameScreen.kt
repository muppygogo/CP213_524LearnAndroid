...
@Composable
fun RandomNameScreen(navController: NavHostController) {
    var nameInput by remember { mutableStateOf("") }
    var names by remember { mutableStateOf(listOf<String>()) }
    var result by remember { mutableStateOf("Press the button!") }

    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Random Name", color = OnPrimary) },
                navigationIcon = {
